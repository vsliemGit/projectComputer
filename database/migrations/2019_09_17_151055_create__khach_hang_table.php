...
class CreateKhachHangTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('KhachHang', function (Blueprint $table) {
            ...
            //$table->string('kh_taiKhoan', 50)->comment('Tài khoản # Tài khoản của khách hàng');
            //$table->string('kh_matKhau', 256)->comment('Mật khẩu # Mật khẩu của khách hàng');
            $table->string('kh_hoTen', 100)->comment('Họ tên # Họ tên khách hàng');
